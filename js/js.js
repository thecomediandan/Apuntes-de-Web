"use strict";
    // Se pone el ancho y altura como propiedad en la etiqueta
    // por un tema de escala, en la hoja de estilos hay un
    // problena de escala y no se ve agradable.
...
contexto.lineWidth = "6"; // Grosor de linea, solo para elementos stro-ke o de trazos de linea
...
contexto.strokeRect(30,50,400,200); // Trazo de un rectangulo, los pri-meros 2 parametros indican donde empieza el rectangulo, y los otros 2 son el ancho y la altura
...
contexto.closePath(); // Cierra los trazos lineTo para que los siguien-tes lineTo comiencen en otro lugar
contexto.beginPath(); // Indicamos el inicio de nuevos puntos para ge-nerar un nuevo trazo con lineTo
